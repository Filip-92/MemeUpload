...
const routes: Routes = [
  {path: '', component: HomeComponent},
  {
    ...
    children: [
      ...
      {path: 'kategoria/:divisionName/ostatnie24H/strona/:pageNumber', component: HomeComponent},
      {path: 'kategoria/:divisionName/ostatnie24H', component: HomeComponent},
      {path: 'poczekalnia/ostatnie24H/strona/:pageNumber', component: HomeComponent},
      {path: 'poczekalnia/ostatnie24H', component: HomeComponent},
      {path: 'ostatnie24H/strona/:pageNumber', component: HomeComponent},
      {path: 'ostatnie24H', component: HomeComponent},
      {path: 'kategoria/:DivisionName/ostatnie48H/strona/:pageNumber', component: HomeComponent},
      {path: 'kategoria/:divisionName/ostatnie48H', component: HomeComponent},
      {path: 'poczekalnia/ostatnie48H/strona/:pageNumber', component: HomeComponent},
      {path: 'poczekalnia/ostatnie48H', component: HomeComponent},
      {path: 'ostatnie48H/strona/:pageNumber', component: HomeComponent},
